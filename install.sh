...
trap 'echo "Omadeb installation failed! You can retry by running: source ~/.local/share/meradeb/install.sh"' ERR
...
source ~/.local/share/meradeb/install/first-run-choices.sh
source ~/.local/share/meradeb/install/identification.sh
