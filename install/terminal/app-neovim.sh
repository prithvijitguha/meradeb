...
if [ ! -d "$HOME/.config/nvim" ]; then
  ...
  cp ~/.local/share/omadeb/configs/neovim/transparency.lua ~/.config/nvim/plugin/after/

  # Default to Tokyo Night theme
  cp ~/.local/share/omadeb/themes/tokyo-night/neovim.lua ~/.config/nvim/lua/plugins/theme.lua

  # Turn off animated scrolling
  cp ~/.local/share/omadeb/configs/neovim/snacks-animated-scrolling-off.lua ~/.config/nvim/lua/plugins/
