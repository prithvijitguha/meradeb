...
# set the everforest theme to start
WALLPAPER_PATH="$HOME/.local/share/meradeb/themes/everforest/backgrounds/1-tree-tops.webp"
WALLPAPER_DIR="$HOME/.local/share/meradeb/themes/everforest"
THEME="everforest"
