...
gsettings set org.gnome.shell.extensions.tilingshell focus-window-left "['<Control>h']"
gsettings set org.gnome.shell.extensions.tilingshell focus-window-right "['<Control>l']"
gsettings set org.gnome.shell.extensions.tilingshell focus-window-up "['<Control>k']"
gsettings set org.gnome.shell.extensions.tilingshell focus-window-down "['<Control>j']"
